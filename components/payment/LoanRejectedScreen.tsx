...
import { LoanRejectedOutcomeSwitcher } from "@/components/payment/LoanRejectedOutcomeSwitcher";
import { BANK_SHEET_OPTIONS, PAYMENT_CHOOSE_ASSETS } from "@/components/payment/payment-choose-assets";
import { cancelBookingRefundCancellationFeeDisplay } from "@/lib/cancel-booking-content";
import {
...
import { loanApplicationPath, loanProcessingPath } from "@/lib/loan-application-urls";
import {
...
export function LoanRejectedScreen() {
  ...
  const cancelHref = useMemo(
    () =>
      `${JOURNEY_PATHS.kyc.cancelBooking}?paid=${BOOKING_LOCK_AMOUNT_INR}&stage=post`,
    [],
  );
