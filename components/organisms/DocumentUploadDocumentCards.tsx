...
import { DocumentUploadSection, type DocumentUploadFile } from "@/components/organisms/DocumentUploadSection";
import { DigilockerFetchButton } from "@/components/molecules/DigilockerFetchButton";
...
type DocumentUploadDocumentCardsProps = {
  ...
  /** Optional wrapper for stagger animations (e.g. RevealStagger). */
