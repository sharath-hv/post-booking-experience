...
import { isStandardDeliveryFlow } from "@/constants/experience-flow-content";
...
import { getDeliveryDateShort, getVehicleUpdateDateFull } from "@/helpers/journey-stage";
...
export type TurnWordsContext = {
  car?: ConciergeCarRef;
  /** True when `/booking/processing` (etc.) follows a completed modify-selection pay. */
   ...
   * `/booking/accepted?earlyDealer=1`.
   */
