...
import { DOWN_PAYMENT_SUCCESS_AUTO_REDIRECT_MS } from "@/components/organisms/payment/DownPaymentInstalmentSuccess";
import {
  BOOKING_PAYMENT_SUCCESS_HERO,
  BOOKING_SUCCESS_LOTTIE_TICK_DATA,
} from "@/components/organisms/payment/booking-success-shared";
