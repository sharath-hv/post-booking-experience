...
const DEFAULT_NEXT_HREF = "/booking/confirmed";

export type BookingProcessingScreenProps = {
  headline?: string;
  ...
  /** Manage-booking sheet — post–car-allocation car card (engine/chassis). */
  manageBookingShowVehicleIdentification?: boolean;
  /** Hide the prior-turn user echo chip (e.g. insurance-issued news). */
