...
import { PaperworkDeadlineFootnote } from "@/components/organisms/concierge/DeadlineCountdownFootnote";
import {
  BOOKING_CAR_COLOR,
  BOOKING_CAR_TITLE,
  BOOKING_CAR_VARIANT,
...
} from "@/helpers/kyc-verification-attempts";
import {
...
import { CAR_SOURCE_NAME, CAR_SOURCE_DETAIL } from "@/constants/dealer-attribution-content";
    ...
    switch (moment) {
      case "arrival": {
        ...
        return {
          ...
          replies: primaryReply(JOURNEY_PATHS.identity.hub),
        };
      }
      ...
      case "dealerSearch": {
        return {
          ...
          footnoteInline: true,
          timeSkip: words.timeSkipLabel
            ? { label: words.timeSkipLabel, href: JOURNEY_PATHS.booking.accepted }
            : undefined,
      ...
      case "earlyDeliveryConfirming":
        return {
          ...
          altTimeSkip: {
            ...
            href: `${JOURNEY_PATHS.booking.accepted}?earlyDealer=1`,
          },
        };
