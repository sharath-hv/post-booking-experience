...
import { LoanApplicationBankSummaryCard } from "@/components/organisms/payment/loan-application/LoanApplicationBankSummaryCard";
...
import { loanApplicationNextPath, loanApplicationPath } from "@/helpers/loan-application-urls";
import {
  ...
  parseInrAmountInput,
} from "@/helpers/loan-emi";
import { createDefaultLoanApplicationState } from "@/helpers/loan-application-state";
