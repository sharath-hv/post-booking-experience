...
export const KYC_ASSETS = {
  ...
  /** Booking processing hero — `/booking/processing` illustration (filename spelling per design export). */
  ...
  /** RTO registration prep hero — `/delivery/rto-prep`. */
  rtoRegistrationProcessHero: asset("RTO Registration process.svg"),
  /** Car delivery scheduling hero — `/delivery/schedule`. */
  carDeliveryHero: asset("Car delivery.svg"),
  /** Car insurance setup hero — `/delivery/insurance-prep`. */
