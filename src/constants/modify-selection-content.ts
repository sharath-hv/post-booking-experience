...
export const MODIFY_SELECTION_PATH = "/booking/modify";
...
export type ModifySelectionOption = {
  ...
  /** Primary CTA on `/booking/modify` when this option is selected. */
...
export const MODIFY_SELECTION_OPTIONS: readonly ModifySelectionOption[] = [
  {
    ...
    continuePath: "/booking/modify/colour",
  ...
  },
  {
    ...
    continuePath: "/booking/modify/variant",
  ...
  },
  {
    ...
    continuePath: "/booking/modify/different-car",
