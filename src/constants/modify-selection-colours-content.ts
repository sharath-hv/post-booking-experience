...
export { MODIFY_SELECTION_CURRENT_SELECTION_HEADING } from "@/constants/modify-selection-content";

export const MODIFY_SELECTION_AVAILABLE_COLOURS_HEADING = "Available colours";

/** Page title on `/booking/modify/colour`. */
...
/** Review screen — `/booking/modify/colour/confirm`. */
export const MODIFY_SELECTION_COLOUR_CONFIRM_PATH = "/booking/modify/colour/confirm";
