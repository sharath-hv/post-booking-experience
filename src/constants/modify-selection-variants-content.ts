import { BOOKING_CAR_VARIANT, BOOKING_EXPRESS_DELIVERY_LINE } from "@/constants/booking-car-card-content";
import { BOOKING_STANDARD_DELIVERY_LINE } from "@/constants/experience-flow-content";
import {
...
/** Colour step after picking a variant — `/booking/modify/variant/colour`. */
export const MODIFY_SELECTION_VARIANT_COLOUR_PATH = "/booking/modify/variant/colour";
...
export const MODIFY_SELECTION_VARIANT_CONFIRM_PATH = "/booking/modify/variant/confirm";
